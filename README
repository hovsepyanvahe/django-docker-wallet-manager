...
5. Once the containers are running, you can access the Django application in your web browser at `http://localhost:8000`.

6. To stop the Docker containers, press `Ctrl + C` in the terminal where Docker Compose is running, and then run the following command to remove the containers:
